    ...
    <div className="flex justify-center rounded-lg items-center mt-3">
      ...
      >
        ...
        <button
          type="button"
          onClick={formclose}
          className="mb-5 ml-5 mt-10 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-1/4 px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
        >
          Close
        </button>
      </form>
